...
def plot_egu_talk():
    ...
    plot_seasonal_mean(variable='$\delta^{18}$Op vs SMOW', data_slt=d18op_aw200e100_slt , cmap=RdBu, units="‰", seasons=["JJA"], 
                       axes=[ax1], fig=fig, vmax=10, vmin=-10, levels=22, domain="Europe", level_ticks=11, cbar_pos = [0.90, 0.55, 0.02, 0.25], title=True, 
                       season_label= [" W2E1 - CTL"], bottom_labels=True, left_labels=True, compare_data1=d18op_aw100e100,
                       compare_data2=d18op_aw200e100, max_pvalue=0.05, plot_stats=True)
