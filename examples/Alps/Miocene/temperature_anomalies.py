# -*- coding: utf-8 -*-
"""
Created on Wed May 17 13:54:52 2023
...
def extract_temp_and_analysis(exp_data, exp_wiso, W1E1_data, W1E1_wiso, diff="missing",
                                    lapse_rate=-0.0056):
    ...
    expected_temp_change = elev_change * lapse_rate # per mil 
    
    simulated_temp_change = exp_temp_data - w1e1_temp_data
    
    missing = simulated_temp_change - expected_temp_change
...
W2E0_278_diff = extract_temp_and_analysis(exp_data=W2E0_278_data, exp_wiso=W2E0_278_wiso, W1E1_data=W1E1_278_data,
                                            W1E1_wiso=W1E1_278_wiso)


W2E0_450_diff = extract_temp_and_analysis(exp_data=W2E0_450_data, exp_wiso=W2E0_450_wiso, W1E1_data=W1E1_450_data,
                                            W1E1_wiso=W1E1_450_wiso) 
      
W2E1_278_diff = extract_temp_and_analysis(exp_data=W2E1_278_data, exp_wiso=W2E1_278_wiso, W1E1_data=W1E1_278_data,
                                            W1E1_wiso=W1E1_278_wiso)

W2E1_450_diff = extract_temp_and_analysis(exp_data=W2E1_450_data, exp_wiso=W2E1_450_wiso, W1E1_data=W1E1_450_data,
                                            W1E1_wiso=W1E1_450_wiso)

W2E15_278_diff = extract_temp_and_analysis(exp_data=W2E15_278_data, exp_wiso=W2E15_278_wiso, W1E1_data=W1E1_278_data,
                                            W1E1_wiso=W1E1_278_wiso)

W2E15_450_diff = extract_temp_and_analysis(exp_data=W2E15_450_data, exp_wiso=W2E15_450_wiso, W1E1_data=W1E1_450_data,
                                            W1E1_wiso=W1E1_450_wiso)

W2E2_278_diff = extract_temp_and_analysis(exp_data=W2E1_278_data, exp_wiso=W2E1_278_wiso, W1E1_data=W1E1_278_data,
                                            W1E1_wiso=W1E1_278_wiso)

W2E2_450_diff = extract_temp_and_analysis(exp_data=W2E1_450_data, exp_wiso=W2E1_450_wiso, W1E1_data=W1E1_450_data,
                                            W1E1_wiso=W1E1_450_wiso)

#plot the anomalies after correcting the lapse rate

def plot_temp_missing():
    ...
    plt.savefig(os.path.join(path_to_plots, "temp_non_adiabatic.svg"), format= "svg", bbox_inches="tight", dpi=600)



def plot_temp_simulated():
    apply_style(fontsize=28, style=None, linewidth=2.5) 
