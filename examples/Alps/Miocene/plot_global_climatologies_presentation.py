...
def animate_prec(i):
    ...
    for j,mname in enumerate(mnames):
        ...
        plot_annual_mean(variable="Precipitation anomalies", data_alt=Mio278_data.get("precipitation").sel(month=j+1), ax=ax,
...
creat_git(path_to_plots_temp, "MIO_278_climatologies_temp")
creat_git(path_to_plots_prec, "MIO_278_climatologies_prec")
creat_git(path_to_plots_d18Op, "MIO_278_climatologies_d18Op")