# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 22:39:53 2024
...
pi_prec_alt = compute_lterm_mean(data=pi_prec_data, time="month", month="JJAS")
...
plot_annual_mean(variable="Precipitation anomalies", data_alt=mio_prec_diff, ax=ax1,
                 cmap="BrBG", units="mm/month [JJAS]", vmax=200, vmin=-200, 
                ...
                domain="West Africa", data_v=mio_v_diff, data_u=mio_u_diff,
...
plot_annual_mean(variable="Precipitation anomalies", data_alt=plio_prec_diff, ax=ax2,
                ...
                domain="West Africa", data_v=plio_v_diff, data_u=plio_u_diff,
...
plot_annual_mean(variable="Precipitation anomalies", data_alt=holocene_prec_diff, ax=ax3,
                ...
                domain="West Africa", data_v=holocene_v_diff, data_u=holocene_u_diff,
                show_arrow_scale=False, plot_winds=True)
...
plt.savefig(os.path.join(path_to_plots, "poster_map_wam.pdf"), format= "pdf", bbox_inches="tight", dpi=600)
