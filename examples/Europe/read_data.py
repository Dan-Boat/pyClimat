...
# read data
PD_data = read_from_path(pd_path, "PD_1980_2014_monthly.nc", decode=False)
PI_data = read_from_path(pi_path, "PI_1003_1017_monthly.nc", decode=False)
LGM_data = read_from_path(lgm_path,"LGM_1003_1017_monthly.nc", decode=False)
PLIO_data = read_from_path(plio_path, "PLIO_1003_1017_monthly.nc", decode=False)
MH_data = read_from_path(mh_path, "MH_1003_1017_monthly.nc", decode=False)

# read wiso
PD_wiso = read_from_path(pd_path, "PD_1980_2014_monthly_wiso.nc", decode=False)
PI_wiso = read_from_path(pi_path, "PI_1003_1017_monthly_wiso.nc", decode=False)
LGM_wiso = read_from_path(lgm_path,"LGM_1003_1017_monthly_wiso.nc", decode=False)
PLIO_wiso = read_from_path(plio_path, "PLIO_1003_1017_monthly_wiso.nc", decode=False)
MH_wiso = read_from_path(mh_path, "MH_1003_1017_monthly_wiso.nc", decode=False)
