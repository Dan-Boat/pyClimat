...
path_to_results= "C:/Users/dboateng/Desktop/Python_scripts/ClimatPackage_repogit/examples/Europe/plots/LGM"

df_nao_ea_to_prec = pd.read_csv(os.path.join(path_to_results, "LGM_NAO_EA_to_prec.csv"))
df_nao_ea_to_t2m = pd.read_csv(os.path.join(path_to_results, "lGM_NAO_EA_to_t2m.csv"))
df_t2m_prec_to_nao = pd.read_csv(os.path.join(path_to_results, "LGM_climate_to_NAO.csv"))
df_prec_ea_to_nao = pd.read_csv(os.path.join(path_to_results, "LGM_prec_EA_to_NAO.csv"))
df_t2m_ea_to_nao = pd.read_csv(os.path.join(path_to_results, "LGM_t2m_EA_to_NAO.csv"))
...
plt.savefig(os.path.join(path_to_results, "causal_regional_means_to_NAO_LGM.svg"), format= "svg", 
...
plt.savefig(os.path.join(path_to_results, "causal_regional_means_to_Prec_t2m_LGM.svg"), format= "svg", 
            bbox_inches="tight", dpi=300)