...
perform_eof_and_store(apply_varimax=False, filesname="ECHAM5-wiso" + "_standard_eof_pd", data=pd_msl,
                      vmax=20, vmin=-20)
perform_eof_and_store(apply_varimax=True, filesname="ECHAM5-wiso" + "_varimax_eof_pd", data=pd_msl,
                      vmax=15, vmin=-15)


# perform_eof_and_store(apply_varimax=False, filesname="ERA5" + "_standard_eof", data=ERA5_msl,
#                       vmax=20, vmin=-20)
# perform_eof_and_store(apply_varimax=True, filesname="ERA5" + "_varimax_eof", data=ERA5_msl,
#                       vmax=15, vmin=-15)