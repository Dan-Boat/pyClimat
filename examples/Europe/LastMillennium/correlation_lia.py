# -*- coding: utf-8 -*-
"""
Created on Wed Nov  1 19:25:23 2023
...
giss_data  = perform_correlation_nao_ea_with_t2m_prec(pcs_path= GISS_DJF_PCs, path_to_data=main_path, nao_mode=1, 
                                                 ...
                                                 select_time=True, 
                                                 time_range=None, use_slice=True, slice_start="1489", 
                                                 slice_end="1849", slice_end_plus="1850")
...
plot_climate_index_correlation(labels=labels, data=data, figname="temp_nao_nh_lia.svg", reg_name="nao_reg_temp", 
                               sig_name="nao_sig_temp")
plot_climate_index_correlation(labels=labels, data=data, figname="temp_ea_nh_lia.svg", reg_name="ea_reg_temp", 
                               sig_name="ea_sig_temp")

plot_climate_index_correlation(labels=labels, data=data, figname="prec_nao_nh_lia.svg", reg_name="nao_reg_prec", 
                               sig_name="nao_sig_prec")
plot_climate_index_correlation(labels=labels, data=data, figname="prec_ea_nh_lia.svg", reg_name="ea_reg_prec", 
                               sig_name="ea_sig_prec")

plot_climate_index_correlation(labels=labels, data=data, figname="d18O_nao_nh_lia.svg", reg_name="nao_reg_d18O", 
                               sig_name="nao_sig_d18O")
plot_climate_index_correlation(labels=labels, data=data, figname="d18O_ea_nh_lia.svg", reg_name="ea_reg_d18O", 
