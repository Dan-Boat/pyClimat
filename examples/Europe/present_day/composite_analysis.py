...
same = (df_echam_pcs["1"]*-1 >0)&(df_echam_pcs["2"]> 0)
...
def cal_diff_nao_ea_index(varname, units=None, index_same=nao_same_echam, index_op=nao_op_echam,
...
plot_correlation(variable="Spearman Coefficients", data=d18op_nao_same_sval, units="-", vmax=1,
                 ...
                 plot_pvalues=True, pvalue_data=d18op_nao_same_sig, bottom_labels=False, title="[A] NAO-$\delta^{18}$Op (EQ)")
...
plot_correlation(variable="Spearman Coefficients", data=d18op_nao_op_sval, units="-", vmax=1,
                 ...
                 level_ticks=7, ax=ax2, fig=fig, plot_pvalues=True, pvalue_data=d18op_nao_op_sig, bottom_labels=False,
                 left_labels=False, title="[B] NAO-$\delta^{18}$Op (OP)")
...
plot_annual_mean(variable='$\delta^{18}$Op vs SMOW', data_alt=d18op_diff, cmap="PiYG", units="‰",
                 ...
                 left_labels=False, bottom_labels=False, label_format="%.1f")
...
plot_correlation(variable="Spearman Coefficients", data=t2m_nao_same_sval, units="-", vmax=1,
                 ...
                 title="[D] NAO-t2m (EQ)", bottom_labels=False)

plot_correlation(variable="Spearman Coefficients", data=t2m_nao_op_sval, units="-", vmax=1,
                 vmin=-1, cmap="PRGn", domain="Europe Wide", levels=22,cbar=False, cbar_orientation="horizontal",
                 level_ticks=7, ax=ax5, fig=fig, plot_pvalues=True, pvalue_data=t2m_nao_op_sig, left_labels=False,
                 title="[E] NAO-t2m (OP)", bottom_labels=False)
...
plot_correlation(variable="Spearman Coefficients", data=prec_nao_op_sval, units="-", vmax=1,
                 vmin=-1, cmap="PRGn", domain="Europe Wide", levels=22,cbar=False, cbar_orientation="horizontal",
                 level_ticks=7, ax=ax8, fig=fig, plot_pvalues=True, pvalue_data=prec_nao_op_sig, left_labels=False,
                 title="[H] NAO-prec (OP)")
...
plot_annual_mean(variable='Precipitation', data_alt=prec_diff, cmap=BrBG, units="mm/month",
                 ...
                 left_labels=False, bottom_labels=True)
